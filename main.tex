...
\myvec{x1\\x2}=\myvec{\frac{-7}{2}\\\frac{-9}{4}}
\end{align}
...
Now, 
\begin{align}
\vec{a}=\vec{e_1}^T\vec{V}\vec{e_1}\\
\implies\myvec{1 & 0}\myvec{1 & 0\\0 & 0}\myvec{1 \\ 0}
&=\vec{1}\\
\vec{b}=\vec{2}\vec{u}^T\vec{e_1}\\
\implies\vec{2}\myvec{\frac{7}{2} & \frac{-1}{2}}\myvec{1 \\ 0}=\vec{7}\\
\vec{c}=\vec{f}=\vec{10}\\
\end{align}
therefore the roots are
\begin{align}
\vec{x}=\myvec{\frac{\myvec{-b}+\sqrt{\vec{b}^2-\vec{4}\vec{a}\vec{c}}}{\vec{2}\vec{a}}}\\
&=\frac{\myvec{-7}+\sqrt{9}}{\vec{2}}=\vec
{-2}\\
\implies\vec{x}=\myvec{\frac{\vec{-b}-\sqrt{\vec{b}^2-\vec{4}\vec{a}\vec{c}}}{\vec{2}\vec{a}}}\\
&=\frac{\myvec{-7}-\sqrt{9}}{\vec{2}}=\vec{-5}\\
\end{align}
\end{document}